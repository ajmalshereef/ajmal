...
# Public variables
The code starts with assigning the name and abbreviation of the token using a string variable. The  name is token name is  'actor' and abbreviation as 'act'
# Mapping variable
